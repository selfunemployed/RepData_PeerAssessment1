...
```
Mean steps taken per day: `r format(meanStepsPerDay, signif=3)`

Median steps taken per day: `r format(medianStepsPerDay, signif=3)`
...
```
The interval with the maximum number of steps is interval: `r maxStepsInterval`
...
```
Number of incomplete rows: `r incompleteRowCount`
...
```
Mean steps taken per day (filled data): `r format(meanStepsPerDayFilled, signif=3)`

Median steps taken per day (filled data): `r format(medianStepsPerDayFilled, signif=3)`
